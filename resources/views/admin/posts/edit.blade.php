    ...
    <div class="bg-white p-4">
        ...
        <form action="{{ route('posts.update', $post->id) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" placeholder="Description" id="blog-content" name="description">{!! old('description', $post->description) !!}</textarea>
            ...
            <div class="mb-3">
                ...
                <select class="form-select" name="category" id="category">
                    ...
                    @foreach ($categories as $category)
                        <option @selected(old('category', $post->category_id) == $category->id) value="{{ $category->id }}">{{ $category->category }}</option>
                    @endforeach
