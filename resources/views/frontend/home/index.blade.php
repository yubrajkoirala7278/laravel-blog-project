          ...
          <div class="row table-data">
              ...
              <article class="card article-card">
                <a href="#">
                  <div class="card-image">
                    <div class="post-info"> <span class="text-uppercase">{{ ($posts[0]->created_at)->format('d M Y')
                        }}</span>
                      <span class="text-uppercase">{{ round(Str::of($posts[0]->description)->wordCount() / 238, 2)}}
                        minutes read</span>
                    </div>
                    <img loading="lazy" decoding="async"
                      src="{{asset('storage/images/post/'.$posts[0]->image->filename)}}" alt="Post Thumbnail"
                      class="w-100">
                  </div>
                </a>
                <div class="card-body px-0 pb-1">
                  ...
                  <h2 class="h1"><a class="post-title" href="#">{{$posts[0]->title}}</a></h2>
            ...
            <div class="col-md-6 mb-4 ">
              <article class="card article-card article-card-sm h-100">
                <a href="#">
                  <div class="card-image">
                    <div class="post-info"> <span class="text-uppercase">{{ ($posts[$i]->created_at)->format('d M Y')
                    }}</span>
                      <span class="text-uppercase">{{ round(Str::of($posts[$i]->description)->wordCount() / 238, 2)}} minutes read</span>
                    </div>
                    <img loading="lazy" decoding="async" src="{{asset('storage/images/post/'.$posts[$i]->image->filename)}}"
                ...
                <div class="card-body px-0 pb-0">
                  ...
                  <h2><a class="post-title" href="#">{{$posts[$i]->title}}</a></h2>
              ...
              <div class="col-lg-12">
                <div class="widget">
                  <div class="widget-body">
                    <img loading="lazy" decoding="async" src="{{asset('frontend/images/author.jpg')}}" alt="About Me"
                      class="w-100 author-thumb-sm d-block">
                    <h2 class="widget-title my-3">Yubraj Koirala</h2>
                    <p class="mb-3 pb-2">Hello, I’m Yubraj Koirala. A Content writter, Developer and Story teller.
                    ...
                    <div class="widget-list">
                      <article class="card mb-4">
                        <div class="card-image">
                          ...
                          <img loading="lazy" decoding="async" src="{{asset('frontend/images/post/post-9.jpg')}}"
                            alt="Post Thumbnail" class="w-100">
                        </div>
                        <div class="card-body px-0 pb-1">
                      ...
                      <a class="media align-items-center" href="article.html">
                        <img loading="lazy" decoding="async" src="{{asset('frontend/images/post/post-2.jpg')}}"
                          alt="Post Thumbnail" class="w-100">
                      ...
                      <a class="media align-items-center" href="article.html">
                        <img loading="lazy" decoding="async" src="{{asset('frontend/images/post/post-5.jpg')}}"
                          alt="Post Thumbnail" class="w-100">
                        <div class="media-body ml-3">
                  ...
                  <div class="widget-body">
                    <ul class="widget-list">
                      @foreach ($categories as $category)
                        <li><a href="#!">{{$category->category}}<span class="ml-auto">(3)</span></a>
                        </li>
                      @endforeach
                    </ul>
                  </div>
              ...
              <div class="col-lg-12 col-md-6">
                <div class="widget">
                  ...
                  <div class="widget-body">
                    <ul class="widget-list">
                      @foreach ($tags as $tag)
                      <li><a href="#!">{{$tag->tag}}<span class="ml-auto">(3)</span></a>
                      </li>
                      @endforeach
                    </ul>
                  </div>
